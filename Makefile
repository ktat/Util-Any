# This Makefile is for the Util::Any extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Util/Any.pm]
#     AUTHOR => [q[Ktat <ktat@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Util::Any]
#     PL_FILES => {  }
#     PREREQ_PM => { Scalar::Util=>q[0], Module::Pluggable=>q[0], String::CamelCase=>q[0], Data::Dumper=>q[0], Hash::Util=>q[0], Test::More=>q[0.88], List::Util=>q[0], ExportTo=>q[0], String::Util=>q[0], Clone=>q[0], List::Pairwise=>q[0], List::MoreUtils=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Util/Any.pm]
#     clean => { FILES=>q[Util-Any-*] }
...
TO_INST_PM = lib/Util/Any.pm

PM_TO_BLIB = lib/Util/Any.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Util/Any.pm $(INST_MAN3DIR)/Util::Any.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''to export any utilities and to create your own utilitiy module'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Util-Any' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  ExportTo: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Hash::Util: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  List::MoreUtils: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  List::Pairwise: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  List::Util: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Module::Pluggable: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Scalar::Util: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  String::CamelCase: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  String::Util: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0.88' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.23' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "to export any utilities and to create your own utilitiy module",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Ktat <ktat@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Util-Any",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "ExportTo" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Hash::Util" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "List::MoreUtils" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "List::Pairwise" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "List::Util" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Module::Pluggable" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Scalar::Util" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "String::CamelCase" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "String::Util" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>to export any utilities and to create your own utilitiy module</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="ExportTo::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Hash::Util" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="List::MoreUtils" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="List::Pairwise" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="String::CamelCase" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="String::Util" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Util/Any.pm blib/lib/Util/Any.pm 
